...
class StudentController extends Controller
{
    ...
    public function charts_test($id){
        ...
        $datas = StudentRecords::whereStudentId($id)->orderBy('month','ASC')->groupBy('difficulty','score','month' )->having('difficulty', '=', 'easy')->select('score', 'month')->get(DB::raw('to_char(created_at, \'YYYY-MON\') as month'));
        dd($datas);
