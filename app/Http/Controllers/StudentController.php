...
class StudentController extends Controller
{
    ...
    public function charts_test($id){
        ...
        $datas = StudentRecords::whereStudentId($id)->select(DB::raw('to_char(created_at, \'YYYY-MON\') as month'))->orderBy('month','ASC')->groupBy('difficulty','score','month' )->having('difficulty', '=', 'easy')->pluck('score', 'month');
        // dd($datas);
